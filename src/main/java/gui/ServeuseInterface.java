...
public class ServeuseInterface extends JFrame {
    ...
    public ServeuseInterface(int serveuseId) {
        ...
        JLabel welcomeLabel = new JLabel("Bonjour , Serveuse");
        ...
        JButton viewOrdersButton = new JButton("voir command");
        ...
        viewMenuButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        new ClientMenuInterface(serveuseId).setVisible(true);
                    }
                });
            }
        });
